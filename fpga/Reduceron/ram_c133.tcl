...
set xci_file $prj_dir/$prj_name.srcs/sources_1/ip/ram_c133/ram_c133.xci
create_ip -name blk_mem_gen -vendor xilinx.com -library ip -version 8.4 -module_name "ram_c133"
set_property -dict [list \
    ...
    CONFIG.Coe_File "$script_path/init_ram_c133.txt"\
    ...
    CONFIG.EN_SAFETY_CKT {false}] [get_ips ram_c133]
generate_target all [get_ips ram_c133]
