...
set xci_file $prj_dir/$prj_name.srcs/sources_1/ip/ram_c1536/ram_c1536.xci
create_ip -name blk_mem_gen -vendor xilinx.com -library ip -version 8.4 -module_name "ram_c1536"
set_property -dict [list \
    ...
    CONFIG.EN_SAFETY_CKT {false}] [get_ips ram_c1536]
generate_target all [get_ips ram_c1536]
